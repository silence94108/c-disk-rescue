...
1. 到 [**Releases**](https://github.com/silence94108/c-disk-rescue/releases) 下载最新的 `c-disk-rescue_x.y.z_x64-setup.exe`,双击安装。
2. 系统要求:**Windows 10 1809+ / Windows 11,x64**。
3. 首次运行若弹出「Windows 已保护你的电脑」:点「更多信息」→「仍要运行」。安装包暂未做数字签名(免费项目),介意可自行用源码构建。
4. 若系统缺少 WebView2 运行时,安装器会引导安装(Win11 自带,少数老 Win10 缺失)。
